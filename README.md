...
3. Set branch to **`Porkbun`** (not `main`)

`main` holds the Next.js source. On every push to `main`, GitHub Actions builds the site and updates the `Porkbun` branch with flat static files (required by Porkbun).
