...
3. Set branch to **`Porkbun`**

`Porkbun` is the only branch used for hosting. It contains the flat static export (`index.html`, assets) that Porkbun serves. Do not point GitHub Connect at `main` or any other branch.
